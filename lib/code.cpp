...
int test()
{
    ...
    D3DCompileFromFile(L"shaders/shaders.hlsl", nullptr, nullptr, "vs_main", "vs_5_0", 0, 0, &vsBlob, nullptr);
    ...
    D3DCompileFromFile(L"shaders/shaders.hlsl", nullptr, nullptr, "ps_main", "ps_5_0", 0, 0, &psBlob, nullptr);
    ...
    D3D11_VIEWPORT viewport = { 0.0f, 0.0f, static_cast<float>(wndWidth), static_cast<float>(wndHeight), 0.0f, 1.0f };
...
extern "C" void dx_set_pfn(PFN _pfn) {
    pfnLoopBottom = _pfn;
}
